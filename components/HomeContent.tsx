      ...
      <section id="home" className="relative overflow-hidden pt-16 md:pt-20">
        ...
        <div className="container mx-auto px-6 py-24 md:py-32 relative">
          <div className="flex flex-col items-center text-center gap-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-3xl font-medium text-accent mt-4 animate-fade-in-up delay-150">
              {t.hero.subtitle}
            </p>
            <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-300 max-w-2xl mt-4 animate-fade-in-up delay-200">
              {t.hero.description}
            </p>
              ...
              >
                ...
                <div className="flex items-center gap-2 max-w-[300px] md:max-w-none text-center md:text-left">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm opacity-80">{t.contact.taxId}</span>
                  </div>
                </div>
              </div>
            </div>
